  ...
  return (
    <div className={styles.card}>
      ...
      <Link
        ...
        className="flex gap-4 items-center justify-center rounded-xl py-1 md:px-6 px-4 bg-[#eaffec] hover:bg-[#d9fcdd] relative w-fit self-center"
      >
        <p className=" text-[#439c4c] font md:font-medium">Consultar</p>

        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-[20px] h-[20px] md:w-[25px] md:h-[25px]" viewBox="0 0 50 50">
          <path
